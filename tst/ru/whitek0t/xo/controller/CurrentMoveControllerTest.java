...
public class CurrentMoveControllerTest {
    @Test
    public void testСurrentMoveWhenNextMoveIsO() throws Exception {
    ...
    @Test
    public void testСurrentMoveWhenNextMoveIsX() throws Exception {
        final CurrentMoveController currentMoveController = new CurrentMoveController();
        for (int i = 0; i < 3; i++) {
            final Field field = new Field(3, 4, 3);
            field.setFigure(new Point(i, 1), Figure.O);
