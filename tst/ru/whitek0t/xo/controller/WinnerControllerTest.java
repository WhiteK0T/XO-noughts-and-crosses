...
public class WinnerControllerTest {
    @Test
    public void testCheckBadParametr() throws Exception {
        final WinnerController winnerController = new WinnerController();
        try {
            winnerController.check(null, null, null);
    ...
    public void testGetWinnerWhenWinnerRow() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            field.setFigure(new Point(i, 3), Figure.X);
    ...
    public void testGetWinnerWhenNoWinnerRow() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            field.setFigure(new Point(i, 3), Figure.O);
    ...
    public void testGetWinnerWhenWinnerDiag1() throws Exception {
        final WinnerController winnerController = new WinnerController();
        final Field field = new Field(4, 5, 3);
    ...
    public void testGetWinnerWhenNoWinnerDiag1() throws Exception {
        final WinnerController winnerController = new WinnerController();
        final Field field = new Field(5, 6, 3);
        field.setFigure(new Point(0, 0), Figure.X);
        field.setFigure(new Point(1, 1), Figure.X);
